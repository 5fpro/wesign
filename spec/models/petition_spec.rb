...
describe Petition do
  ...
  describe "progress should be calculate" do
    ...
    it "has no targeting_count & signs_count > 10000" do
      ...
      @petition.reload
      @petition.real_targeting_count.should == 30000
    end
  end
end
